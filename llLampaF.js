(function () {
    ...
    function analyze(movie) {
        return Promise.all([ loadCredits(movie), loadMeta(movie) ]).then(function(arr) {
            ...
            if (q && !/CAM|TS|HDCAM|SCR|WORKPRINT/i.test(q)) addP('🎥 высокое качество картинки  (' + (q || 'HD') + ')', 8);
            if (runtime > 0 && runtime <= 120) addP('🕐 можно уложиться за вечер (' + runtime + ' мин.)', 6);
            ...
            if (fNudity) addC('🫣 откровенность,нагота', 14);
