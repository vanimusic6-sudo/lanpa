(function () {
    ...
    function injectCSS() {
        try {
            ...
            s.innerHTML =
                ...
                '@media(max-width:640px){.sw-modal-content{padding:16px 16px 32px}.sw-columns{grid-template-columns:1fr}.sw-verdict-word{font-size:2.1em}.sw-label{font-size:1.5em;padding:0 88px}.sw-dice{width:60px;height:60px;margin-top:-30px;left:12px}}';
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v26.0 (restored modal scroll for TV + touch)');
    }
