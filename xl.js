(function () {
    ...
    /* ===== СТИЛИ (+ обводка фокусного блока для TV/ПК) ===== */
    function injectCSS() {
        try {
    ...
    /* ===== БЛОЧНАЯ НАВИГАЦИЯ (TV/ПК): телепорт фокуса + докрутка контейнера ===== */
    function swSetFocus(i) {
        try {
            ...
            try { el[0].scrollIntoView({ block: 'nearest' }); } catch(e) {}
    ...
    /* ===== BACK / КОНТРОЛЛЕР (TV: телепорт по блокам; смартфон: не трогает свайп) ===== */
    ...
    /* ===== РЕНДЕР (блоки помечены sw-focusable для TV-навигации) ===== */
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v22.5 (TV block-nav teleport + smartphone swipe).');
    }
