(function () {
    ...
    /* ==========================================================================
       СТИЛИ (+ мягкое появление контента)
       ========================================================================== */
    ...
    /* ==========================================================================
       УТИЛИТЫ + ЗАГРУЗКА ДАННЫХ (credits / keywords / возрастной ценз)
       ========================================================================== */
    ...
    // Ленивая догрузка keywords + content_ratings штатным ключом Lampa (кэш по id)
    var _extraCache = {};
    ...
    /* ==========================================================================
       АНАЛИЗАТОР v9.3 (флаги опасности -> семейный/возраст)
       ========================================================================== */
    ...
    function analyze(movie) {
        return Promise.all([ loadCredits(movie), loadExtra(movie) ]).then(function(arr) {
            ...
            // --- ФЛАГИ ОПАСНОСТИ (3 слоя: синопсис + теги + жанры) ---
            ...
            // --- СЕМЕЙНЫЙ: детский жанр/тег И нет ни одного флага И ценз не выше 12 ---
            ...
            // Кому подходит (рандомный порядок)
            var AW = [
    ...
    /* ==========================================================================
       МОДАЛКА (один open -> Back не ломается)
       ========================================================================== */
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v9.3 initialized (keywords + age rating).');
    }
